...
void Compass::_probe_external_i2c_compasses(void)
{
    ...
    FOREACH_I2C_EXTERNAL(bus) {
        ADD_BACKEND(DRIVER_AK09911C, AP_Compass_AK09911C::probe(
            GET_I2C_DEVICE(bus, HAL_COMPASS_AK09911C_I2C_ADDR),
            true, ROTATION_NONE));
    }
    FOREACH_I2C_EXTERNAL(bus) {
        ADD_BACKEND(DRIVER_AK09911C, AP_Compass_AK09911C::probe(
            GET_I2C_DEVICE(bus, HAL_COMPASS_AK09911C_I2C_ADDR2),
            true, ROTATION_NONE));
    }
#if !defined(HAL_SKIP_AUTO_INTERNAL_I2C_PROBE)
    FOREACH_I2C_EXTERNAL(bus) {
